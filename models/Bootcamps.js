...
BootcampShema.pre('save', async function(next) {
  ...
  // Do not save address in dB since we have now formattedAddress:
  this.address = undefined;

  next();
});

// Cascade delete courseswhen bootcamp is deleted:
BootcampShema.pre('remove', async function(next) {
  console.log(`Courses being removed for the bootcamp ID: ${this._id}`);
